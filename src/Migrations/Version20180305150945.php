 ...
 */
class Version20180305150945 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE comment ADD content INT NOT NULL');
        $this->addSql('ALTER TABLE comment ADD CONSTRAINT FK_9474526CBF396750 FOREIGN KEY (id) REFERENCES post (id)');
    }
